/*
    функцию appendToBody передаются 3 параметра:
...
/**
 * @param {Number} childrenCount число эл-в на каждом узле
 * @param {Number} currentLevel тек. лвл корневых элементов
 * @param {Number} maxLevel макс.лвл вложености дерева
 */
